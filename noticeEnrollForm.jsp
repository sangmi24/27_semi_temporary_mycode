         ...
         <div class="content_detail">
            ...
            <table id="form_table" align="center">
                ...
                <tr>
                    ...
                    <td width="600"><input type="text" name="title" style="width:500px;" placeholder="제목을 입력하세요"> </td>
                </tr>
                <tr>
                    <th height="35">작성자</th>
                    <td>admin</td>
                ...
                <tr style="border-bottom:1px solid black;">
                    <th height="35">작성일</th>
                    <td><input type="date" name="date_1" style="width:500px;"></td>
                </tr>
            </table>
            <div id="text_outer">
            <textarea id="text_insert" name="des" rows="14" cols="91" placeholder="내용을 입력하세요" required></textarea>
            </div>
