 ...
 <%@ include file="../common/header_admin.jsp" %>
  <br><br><br>
       ...
       <div class="content">
        <div class="content_title" style="color:rgba(36, 49, 121, 0.9)";>
         ...
         <div class="content_detail">
            ...
            <form action="" method="">
            <p style="font-size:30px; font-weight:500px;" > 제목 </p> <p width="500px"><%= f.getFaqTitle() %></p>  
             <br>
             <br> 
             <hr style="border:1px solid rgba(73, 71, 71, 0.5)";>
             <p style="font-size: 30px; font-weight: 500px; ">내용</p>
            <div id="text_outer">
   ...
   <div id="paging" align="center">
        ...
        <!--현재 로그인한 사용자가 해당 글을 작성한 작성자일 경우에만 삭제하기 버튼이 보이게끔 로그인하고 확인해보기!-->
