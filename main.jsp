    ...
    <div class="jumbotron text-center" style="margin-bottom:0;" id="title">
     <div id="header_3">
      ...
      <nav class="navbar-default">
            <a class="navbar-brand" href="#" id="l1">제품보기</a>
            <a class="navbar-brand" href="#" id="l2">건강매거진</a>
            <a class="navbar-brand" href="reviewlist.re?currentPage=1" id="l3">고객후기</a>
            <a class="navbar-brand" href="#" id="l4">고객센터
            </a>
      </nav>
