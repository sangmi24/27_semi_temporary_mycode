            ...
            <div class="content_detail">
                ...
                <div class="cd_content">
                    ...
                    <div class="cd_text">
                        ...
                        <textarea name="" class="cd_text2" cols="80" rows="10" placeholder="내용을 입력해주세요."></textarea>
                        <div class="cd_text3"><button type="submit" class="btn btn-light btn-sm" style="opacity: 0.7; background-color: gray; color: white; width:70px;"> 저장 </button></div>
